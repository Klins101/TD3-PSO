...
CONFIG = {
    ...
    'model_path': 'models/best_td3pso_model.pth',
...
class TD3PSOCrazyflieController:
    ...
    def _save_data(self):
        filename = f"crazyflie_td3pso_data.csv"
    ...
    def _plot_results(self):
        ...
        fig.suptitle('TD3-PSO Crazyflie Hardware Flight Results', fontsize=16, fontweight='bold')
        ...
        axes[1, 0].set_title('TD3-PSO Control Action')
        ...
        plot_filename = f"crazyflie_td3pso_plot.png"
        plt.savefig(plot_filename, dpi=150, bbox_inches='tight')
        print(f" Flight plots saved to: {plot_filename}")
...
def main():
    ...
    try:
        with SyncCrazyflie(CONFIG['uri'], cf=Crazyflie(rw_cache='./cache')) as scf:
            ...
            controller = TD3PSOCrazyflieController(scf, CONFIG)
